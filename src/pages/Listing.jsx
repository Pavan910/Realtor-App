    ...
    <main>
        ...
        <div className='m-4 flex flex-col md:flex-row max-w-6xl lg:mx-auto p-4 rounded-lg shadow-lg bg-white lg:space-x-5'>
            <div className=' w-full'>
                <p className="text-2xl font-bold mb-3 text-blue-900">{listing.name} - Rs {listing.offer ? listing.discountedPrice : listing.regularPrice}
                ...
                <p className='mt-3 mb-3'><span className='font-semibolf'>Description - </span>{listing.Description}</p>
