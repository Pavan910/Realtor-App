  ...
  return <li className='relative bg-white flex flex-col justify-between items-center shadow-md hover:shadow-xl rounded-md overflow-hidden transition-shadow duration-150 m-[10px]'>
    ...
    <div className='w-full p-[10px'>
      <div className='flex items-center space-x-1'>
        ...
        <p className='font-semibold text-sm mg-[2px] text-gray-600 truncate'>{listing.address}</p>
      </div>
        <p className='font-semibold m-0 text-xl truncate'>{listing.name}</p>
        <p className='text-[#457b9d] mt-2 font-semibold'>Rs {listing.offer?listing.discountedPrice : listing.regularPrice}
